...
export default function App() {
  ...
  const selectAll = () => {
    if (selected.length === videos.length) {
      ...
      setSelected(videos.map(v => String(v.id)));
    }
  };

  // تحميل فيديو واحد مباشرة
  ...
  const isDownloading = (id: string) => downloadingId === String(id);
          ...
          {isZipping && (
            <div className="progress-wrap">
              ...
              <div className="progress-sub">
                {zipPhase === "compress" ? `${zipCompressProgress}% مكتمل` : `تم تحميل ${zipDone} فيديو`}
              </div>
                    ...
                    >
                      ...
                      <div className="dl-btn-wrap">
                        <button
                          ...
                          disabled={isDownloading(vid_id) || isZipping}
                        >
                          {isDownloading(vid_id) ? "⏳ جاري..." : "⬇ تحميل"}
                        </button>
                      </div>
                    </div>
                  );
